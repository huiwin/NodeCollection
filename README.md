...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 129 | 上游订阅解析后节点数 |
| 可用节点 | 129 | 测速后存活节点数 (剔除前) |
| 最终输出 | 129 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 215ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 179 | 20 | 8 | 40.0% | 402ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 45 | 23 | 22 | 95.7% | 409ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 15 | 5 | 5 | 100.0% | 38ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 34 | 4 | 4 | 100.0% | 189ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 180 | 11 | 10 | 90.9% | 134ms | ✅ 正常 |
