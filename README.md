...
| 可用节点 | 118 | 测速后存活节点数 (剔除前) |
| 最终输出 | 118 | 体积截断后实际输出节点数 |
| 可用率 | 72.4% | 可用节点 / 解析总数 |
| 平均延迟 | 237ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 162 | 3 | 3 | 100.0% | 149ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 42 | 19 | 19 | 100.0% | 465ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 14 | 14 | 100.0% | 22ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 49 | 6 | 6 | 100.0% | 435ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 110 | 7 | 7 | 100.0% | 146ms | ✅ 正常 |
