...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 326 | 上游订阅解析后节点数 |
| 可用节点 | 216 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 66.3% | 可用节点 / 解析总数 |
| 平均延迟 | 166ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 25 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 96 | 10 | 10 | 100.0% | 121ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 18 | 6 | 6 | 100.0% | 362ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 14 | 14 | 100.0% | 28ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 74 | 22 | 22 | 100.0% | 44ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 169 | 8 | 8 | 100.0% | 245ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 198 | 25 | 25 | 100.0% | 66ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 192 | 65 | 65 | 100.0% | 184ms | ✅ 正常 |
