...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 333 | 上游订阅解析后节点数 |
| 可用节点 | 270 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 81.1% | 可用节点 / 解析总数 |
| 平均延迟 | 131ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 24 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 94 | 9 | 9 | 100.0% | 125ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 30 | 7 | 7 | 100.0% | 536ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 20 | 20 | 100.0% | 12ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 41 | 5 | 5 | 100.0% | 133ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 67 | 5 | 5 | 100.0% | 260ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 520 | 102 | 102 | 100.0% | 51ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 139 | 43 | 43 | 100.0% | 139ms | ✅ 正常 |
