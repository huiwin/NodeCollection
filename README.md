...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1115 | 上游订阅解析后节点数 |
| 可用节点 | 1072 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 96.1% | 可用节点 / 解析总数 |
| 平均延迟 | 170ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 16 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 121 | 6 | 6 | 100.0% | 106ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 47 | 14 | 10 | 71.4% | 377ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 17 | 17 | 100.0% | 24ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 68 | 3 | 3 | 100.0% | 64ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 230 | 8 | 8 | 100.0% | 280ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 319 | 103 | 96 | 93.2% | 27ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1647 | 863 | 252 | 29.2% | 220ms | ✅ 正常 |
