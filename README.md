...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1182 | 上游订阅解析后节点数 |
| 可用节点 | 1160 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 98.1% | 可用节点 / 解析总数 |
| 平均延迟 | 206ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 7 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 113 | 21 | 10 | 47.6% | 167ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 52 | 15 | 9 | 60.0% | 386ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 14 | 14 | 100.0% | 3ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 140 | 18 | 18 | 100.0% | 191ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 200 | 7 | 7 | 100.0% | 270ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 398 | 81 | 81 | 100.0% | 11ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1637 | 918 | 248 | 27.0% | 248ms | ✅ 正常 |
