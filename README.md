...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 313 | 上游订阅解析后节点数 |
| 可用节点 | 273 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 87.2% | 可用节点 / 解析总数 |
| 平均延迟 | 137ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 12 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 73 | 3 | 3 | 100.0% | 174ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 30 | 7 | 7 | 100.0% | 512ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 17 | 17 | 100.0% | 18ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 25 | 3 | 3 | 100.0% | 103ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 67 | 5 | 5 | 100.0% | 284ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 520 | 103 | 103 | 100.0% | 47ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 138 | 40 | 40 | 100.0% | 151ms | ✅ 正常 |
