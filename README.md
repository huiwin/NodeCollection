...
| 可用节点 | 233 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 72.6% | 可用节点 / 解析总数 |
| 平均延迟 | 120ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 30 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 94 | 3 | 3 | 100.0% | 150ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 28 | 7 | 7 | 100.0% | 558ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 12 | 12 | 100.0% | 6ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 46 | 5 | 5 | 100.0% | 163ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 167 | 8 | 8 | 100.0% | 198ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 366 | 88 | 88 | 100.0% | 27ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 171 | 51 | 51 | 100.0% | 150ms | ✅ 正常 |
