...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 74 | 上游订阅解析后节点数 |
| 可用节点 | 74 | 测速后存活节点数 (剔除前) |
| 最终输出 | 74 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 260ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 194 | 21 | 9 | 42.9% | 269ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 43 | 24 | 17 | 70.8% | 381ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 16 | 16 | 100.0% | 23ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 45 | 10 | 10 | 100.0% | 322ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 227 | 3 | 3 | 100.0% | 606ms | ✅ 正常 |
