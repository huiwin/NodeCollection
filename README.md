...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 155 | 上游订阅解析后节点数 |
| 可用节点 | 71 | 测速后存活节点数 (剔除前) |
| 最终输出 | 71 | 体积截断后实际输出节点数 |
| 可用率 | 45.8% | 可用节点 / 解析总数 |
| 平均延迟 | 198ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 33 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 142 | 4 | 4 | 100.0% | 212ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 56 | 13 | 13 | 100.0% | 478ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 13 | 6 | 6 | 100.0% | 18ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 19 | 2 | 2 | 100.0% | 220ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 262 | 10 | 10 | 100.0% | 227ms | ✅ 正常 |
