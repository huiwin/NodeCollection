...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 151 | 上游订阅解析后节点数 |
| 可用节点 | 67 | 测速后存活节点数 (剔除前) |
| 最终输出 | 67 | 体积截断后实际输出节点数 |
| 可用率 | 44.4% | 可用节点 / 解析总数 |
| 平均延迟 | 233ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 24 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 134 | 3 | 3 | 100.0% | 135ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 56 | 14 | 14 | 100.0% | 512ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 13 | 6 | 6 | 100.0% | 27ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 15 | 1 | 1 | 100.0% | 222ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 117 | 10 | 10 | 100.0% | 177ms | ✅ 正常 |
