...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 143 | 上游订阅解析后节点数 |
| 可用节点 | 143 | 测速后存活节点数 (剔除前) |
| 最终输出 | 143 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 181 | 15 | 4 | 26.7% | 157ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 63 | 44 | 38 | 86.4% | 212ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 13 | 13 | 100.0% | 10ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 59 | 5 | 4 | 80.0% | 210ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 196 | 10 | 9 | 90.0% | 190ms | ✅ 正常 |
