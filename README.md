...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 70 | 上游订阅解析后节点数 |
| 可用节点 | 70 | 测速后存活节点数 (剔除前) |
| 最终输出 | 70 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 206 | 24 | 10 | 41.7% | 351ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 49 | 19 | 17 | 89.5% | 298ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 13 | 13 | 100.0% | 18ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 126 | 11 | 8 | 72.7% | 210ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 173 | 3 | 3 | 100.0% | 336ms | ✅ 正常 |
