...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 82 | 上游订阅解析后节点数 |
| 可用节点 | 82 | 测速后存活节点数 (剔除前) |
| 最终输出 | 82 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 148ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 193 | 18 | 6 | 33.3% | 222ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 49 | 23 | 21 | 91.3% | 238ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 18 | 18 | 100.0% | 8ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 140 | 20 | 18 | 90.0% | 147ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 220 | 3 | 3 | 100.0% | 222ms | ✅ 正常 |
