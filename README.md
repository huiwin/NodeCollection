...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1152 | 上游订阅解析后节点数 |
| 可用节点 | 1089 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 94.5% | 可用节点 / 解析总数 |
| 平均延迟 | 227ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 17 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 118 | 29 | 18 | 62.1% | 120ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 31 | 10 | 6 | 60.0% | 707ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 12 | 12 | 100.0% | 29ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 37 | 12 | 12 | 100.0% | 373ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 217 | 7 | 7 | 100.0% | 326ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 342 | 101 | 101 | 100.0% | 61ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1630 | 904 | 276 | 30.5% | 283ms | ✅ 正常 |
