...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 300 | 上游订阅解析后节点数 |
| 可用节点 | 207 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 69.0% | 可用节点 / 解析总数 |
| 平均延迟 | 456ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 8 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 80 | 10 | 10 | 100.0% | 557ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 18 | 8 | 8 | 100.0% | 650ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 13 | 13 | 100.0% | 14ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 13 | 0 | 0 | 0.0% | - | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 166 | 8 | 8 | 100.0% | 267ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 198 | 26 | 26 | 100.0% | 92ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 209 | 57 | 57 | 100.0% | 375ms | ✅ 正常 |
