...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1062 | 上游订阅解析后节点数 |
| 可用节点 | 1007 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 94.8% | 可用节点 / 解析总数 |
| 平均延迟 | 211ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 7 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 163 | 20 | 9 | 45.0% | 66ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 31 | 6 | 5 | 83.3% | 261ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 16 | 10 | 10 | 100.0% | 115ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 27 | 4 | 4 | 100.0% | 361ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 238 | 14 | 14 | 100.0% | 319ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 605 | 91 | 91 | 100.0% | 16ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1639 | 853 | 274 | 32.1% | 277ms | ✅ 正常 |
