...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 149 | 上游订阅解析后节点数 |
| 可用节点 | 149 | 测速后存活节点数 (剔除前) |
| 最终输出 | 149 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 212 | 24 | 11 | 45.8% | 148ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 63 | 25 | 21 | 84.0% | 188ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 11 | 11 | 100.0% | 35ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 36 | 10 | 9 | 90.0% | 120ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 247 | 16 | 14 | 87.5% | 196ms | ✅ 正常 |
