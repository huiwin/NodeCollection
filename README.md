...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1058 | 上游订阅解析后节点数 |
| 可用节点 | 995 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 94.0% | 可用节点 / 解析总数 |
| 平均延迟 | 243ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 18 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 156 | 5 | 5 | 100.0% | 131ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 31 | 6 | 5 | 83.3% | 380ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 14 | 5 | 5 | 100.0% | 51ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 80 | 8 | 8 | 100.0% | 80ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 245 | 10 | 10 | 100.0% | 1164ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 363 | 100 | 100 | 100.0% | 129ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1629 | 847 | 242 | 28.6% | 224ms | ✅ 正常 |
