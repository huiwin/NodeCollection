...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 161 | 上游订阅解析后节点数 |
| 可用节点 | 88 | 测速后存活节点数 (剔除前) |
| 最终输出 | 88 | 体积截断后实际输出节点数 |
| 可用率 | 54.7% | 可用节点 / 解析总数 |
| 平均延迟 | 253ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 27 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 162 | 3 | 3 | 100.0% | 188ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 42 | 18 | 18 | 100.0% | 626ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 6 | 6 | 100.0% | 38ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 56 | 10 | 10 | 100.0% | 314ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 293 | 9 | 9 | 100.0% | 201ms | ✅ 正常 |
