...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 150 | 上游订阅解析后节点数 |
| 可用节点 | 66 | 测速后存活节点数 (剔除前) |
| 最终输出 | 66 | 体积截断后实际输出节点数 |
| 可用率 | 44.0% | 可用节点 / 解析总数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 134 | 3 | 3 | 100.0% | 154ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 56 | 14 | 14 | 100.0% | 274ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 12 | 6 | 6 | 100.0% | 75ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 13 | 0 | 0 | 0.0% | - | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 225 | 10 | 10 | 100.0% | 196ms | ✅ 正常 |
