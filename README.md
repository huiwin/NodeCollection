...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 230 | 上游订阅解析后节点数 |
| 可用节点 | 230 | 测速后存活节点数 (剔除前) |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 175 | 20 | 9 | 45.0% | 180ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 23 | 8 | 7 | 87.5% | 410ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 11 | 11 | 100.0% | 18ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 79 | 7 | 7 | 100.0% | 290ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 251 | 85 | 75 | 88.2% | 88ms | ✅ 正常 |
