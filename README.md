...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 210 | 上游订阅解析后节点数 |
| 可用节点 | 121 | 测速后存活节点数 (剔除前) |
| 最终输出 | 121 | 体积截断后实际输出节点数 |
| 可用率 | 57.6% | 可用节点 / 解析总数 |
| 平均延迟 | 95ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 16 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 153 | 3 | 3 | 100.0% | 129ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 56 | 12 | 12 | 100.0% | 255ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 17 | 5 | 5 | 100.0% | 63ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 69 | 9 | 9 | 100.0% | 65ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 276 | 60 | 60 | 100.0% | 36ms | ✅ 正常 |
