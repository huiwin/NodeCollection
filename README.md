...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 120 | 上游订阅解析后节点数 |
| 可用节点 | 120 | 测速后存活节点数 (剔除前) |
| 最终输出 | 120 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 272ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 159 | 15 | 3 | 20.0% | 219ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 45 | 24 | 22 | 91.7% | 429ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 5 | 5 | 100.0% | 666ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 62 | 12 | 12 | 100.0% | 71ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 255 | 14 | 10 | 71.4% | 180ms | ✅ 正常 |
