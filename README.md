...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 378 | 上游订阅解析后节点数 |
| 可用节点 | 326 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 86.2% | 可用节点 / 解析总数 |
| 平均延迟 | 151ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 27 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 83 | 7 | 7 | 100.0% | 166ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 28 | 6 | 6 | 100.0% | 324ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 17 | 17 | 100.0% | 6ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 27 | 1 | 1 | 100.0% | 2ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 170 | 8 | 8 | 100.0% | 211ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 438 | 122 | 109 | 89.3% | 41ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 183 | 57 | 57 | 100.0% | 260ms | ✅ 正常 |
