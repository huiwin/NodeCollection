...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 203 | 上游订阅解析后节点数 |
| 可用节点 | 116 | 测速后存活节点数 (剔除前) |
| 最终输出 | 116 | 体积截断后实际输出节点数 |
| 可用率 | 57.1% | 可用节点 / 解析总数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 169 | 7 | 7 | 100.0% | 117ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 56 | 12 | 12 | 100.0% | 628ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 3 | 3 | 100.0% | 3ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 24 | 0 | 0 | 0.0% | - | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 300 | 60 | 60 | 100.0% | 47ms | ✅ 正常 |
