...
| 可用节点 | 54 | 测速后存活节点数 (剔除前) |
| 最终输出 | 54 | 体积截断后实际输出节点数 |
| 可用率 | 45.4% | 可用节点 / 解析总数 |
| 平均延迟 | 179ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 3 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 156 | 5 | 5 | 100.0% | 335ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 31 | 5 | 5 | 100.0% | 141ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 14 | 5 | 5 | 100.0% | 66ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 80 | 8 | 8 | 100.0% | 186ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 245 | 10 | 10 | 100.0% | 266ms | ✅ 正常 |
