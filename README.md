...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 60 | 上游订阅解析后节点数 |
| 可用节点 | 60 | 测速后存活节点数 (剔除前) |
| 最终输出 | 60 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 152ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 180 | 24 | 9 | 37.5% | 223ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 43 | 17 | 15 | 88.2% | 225ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 16 | 16 | 100.0% | 16ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | - | - | - | - | - | ⚠️ 异常 (1 次失败) |
| maflya | [maflya](https://sub.maflya.com/) | 174 | 3 | 3 | 100.0% | 296ms | ✅ 正常 |
