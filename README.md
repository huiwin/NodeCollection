...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 220 | 上游订阅解析后节点数 |
| 可用节点 | 220 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 154ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 170 | 20 | 9 | 45.0% | 332ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 23 | 10 | 9 | 90.0% | 390ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 11 | 11 | 100.0% | 126ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 24 | 2 | 2 | 100.0% | 138ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 185 | 79 | 73 | 92.4% | 48ms | ✅ 正常 |
