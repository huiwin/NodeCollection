...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 325 | 上游订阅解析后节点数 |
| 可用节点 | 217 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 66.8% | 可用节点 / 解析总数 |
| 平均延迟 | 249ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 19 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 96 | 16 | 16 | 100.0% | 394ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 18 | 6 | 6 | 100.0% | 674ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 17 | 17 | 100.0% | 6ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 17 | 1 | 1 | 100.0% | 144ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 166 | 8 | 8 | 100.0% | 352ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 198 | 26 | 26 | 100.0% | 72ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 215 | 71 | 71 | 100.0% | 215ms | ✅ 正常 |
