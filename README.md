...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 268 | 上游订阅解析后节点数 |
| 可用节点 | 193 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 72.0% | 可用节点 / 解析总数 |
| 平均延迟 | 103ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 24 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 125 | 17 | 17 | 100.0% | 95ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 52 | 9 | 9 | 100.0% | 362ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 10 | 10 | 100.0% | 20ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 37 | 4 | 4 | 100.0% | 29ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 238 | 8 | 8 | 100.0% | 263ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 520 | 99 | 99 | 100.0% | 44ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 142 | 38 | 38 | 100.0% | 183ms | ✅ 正常 |
