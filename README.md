...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1139 | 上游订阅解析后节点数 |
| 可用节点 | 1094 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 96.0% | 可用节点 / 解析总数 |
| 平均延迟 | 212ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 10 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 105 | 20 | 9 | 45.0% | 166ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 50 | 21 | 8 | 38.1% | 402ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 16 | 16 | 100.0% | 11ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 66 | 3 | 3 | 100.0% | 189ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 74 | 8 | 8 | 100.0% | 265ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 342 | 103 | 103 | 100.0% | 71ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1595 | 893 | 255 | 28.6% | 279ms | ✅ 正常 |
