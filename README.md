...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 315 | 上游订阅解析后节点数 |
| 可用节点 | 256 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 81.3% | 可用节点 / 解析总数 |
| 平均延迟 | 114ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 12 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 94 | 5 | 5 | 100.0% | 167ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 28 | 7 | 7 | 100.0% | 324ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 17 | 17 | 100.0% | 3ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 51 | 2 | 2 | 100.0% | 108ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 166 | 8 | 8 | 100.0% | 192ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 366 | 91 | 89 | 97.8% | 21ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 152 | 47 | 47 | 100.0% | 194ms | ✅ 正常 |
