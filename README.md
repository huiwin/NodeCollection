...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1208 | 上游订阅解析后节点数 |
| 可用节点 | 1173 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 97.1% | 可用节点 / 解析总数 |
| 平均延迟 | 228ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 28 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 109 | 7 | 7 | 100.0% | 106ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 50 | 21 | 8 | 38.1% | 346ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 16 | 7 | 7 | 100.0% | 38ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 67 | 5 | 4 | 80.0% | 149ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 218 | 8 | 8 | 100.0% | 455ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 569 | 180 | 167 | 92.8% | 133ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1612 | 887 | 268 | 30.2% | 295ms | ✅ 正常 |
