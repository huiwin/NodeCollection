...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1174 | 上游订阅解析后节点数 |
| 可用节点 | 1130 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 96.3% | 可用节点 / 解析总数 |
| 平均延迟 | 173ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 20 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 83 | 4 | 3 | 75.0% | 148ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 52 | 15 | 10 | 66.7% | 476ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 18 | 18 | 100.0% | 35ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 70 | 4 | 4 | 100.0% | 71ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 200 | 7 | 7 | 100.0% | 189ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 398 | 88 | 88 | 100.0% | 22ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1637 | 919 | 238 | 25.9% | 217ms | ✅ 正常 |
