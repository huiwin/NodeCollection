...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 77 | 上游订阅解析后节点数 |
| 可用节点 | 77 | 测速后存活节点数 (剔除前) |
| 最终输出 | 77 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 162ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 161 | 18 | 5 | 27.8% | 365ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 59 | 24 | 17 | 70.8% | 224ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 19 | 19 | 100.0% | 18ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 49 | 10 | 9 | 90.0% | 189ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 223 | 6 | 6 | 100.0% | 236ms | ✅ 正常 |
