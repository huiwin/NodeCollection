...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 350 | 上游订阅解析后节点数 |
| 可用节点 | 316 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 90.3% | 可用节点 / 解析总数 |
| 平均延迟 | 273ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 3 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 76 | 10 | 10 | 100.0% | 415ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 32 | 10 | 10 | 100.0% | 684ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 16 | 16 | 100.0% | 12ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 12 | 3 | 2 | 66.7% | 114ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 239 | 11 | 10 | 90.9% | 175ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 345 | 83 | 83 | 100.0% | 16ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 220 | 66 | 66 | 100.0% | 306ms | ✅ 正常 |
