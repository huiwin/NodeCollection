...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 312 | 上游订阅解析后节点数 |
| 可用节点 | 216 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 69.2% | 可用节点 / 解析总数 |
| 平均延迟 | 341ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 35 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 87 | 12 | 12 | 100.0% | 413ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 18 | 9 | 9 | 100.0% | 568ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 9 | 9 | 100.0% | 29ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 71 | 8 | 8 | 100.0% | 119ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 175 | 11 | 11 | 100.0% | 225ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 198 | 26 | 26 | 100.0% | 92ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 216 | 63 | 63 | 100.0% | 180ms | ✅ 正常 |
