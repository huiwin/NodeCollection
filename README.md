...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 89 | 上游订阅解析后节点数 |
| 可用节点 | 89 | 测速后存活节点数 (剔除前) |
| 最终输出 | 89 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 155ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 204 | 26 | 13 | 50.0% | 60ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 59 | 25 | 19 | 76.0% | 351ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 14 | 13 | 92.9% | 13ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 60 | 18 | 16 | 88.9% | 89ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 234 | 6 | 6 | 100.0% | 227ms | ✅ 正常 |
