...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 100 | 上游订阅解析后节点数 |
| 可用节点 | 100 | 测速后存活节点数 (剔除前) |
| 最终输出 | 100 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 139ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 177 | 32 | 18 | 56.2% | 215ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 43 | 18 | 17 | 94.4% | 201ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 17 | 17 | 100.0% | 28ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 128 | 30 | 29 | 96.7% | 114ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 186 | 3 | 3 | 100.0% | 199ms | ✅ 正常 |
