...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 191 | 上游订阅解析后节点数 |
| 可用节点 | 191 | 测速后存活节点数 (剔除前) |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 197 | 23 | 10 | 43.5% | 82ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 63 | 44 | 36 | 81.8% | 349ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 8 | 8 | 100.0% | 10ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 40 | 10 | 7 | 70.0% | 520ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 317 | 10 | 9 | 90.0% | 342ms | ✅ 正常 |
