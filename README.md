...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1155 | 上游订阅解析后节点数 |
| 可用节点 | 1092 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 94.5% | 可用节点 / 解析总数 |
| 平均延迟 | 214ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 16 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 107 | 20 | 9 | 45.0% | 590ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 44 | 14 | 9 | 64.3% | 473ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 16 | 16 | 100.0% | 14ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 50 | 12 | 12 | 100.0% | 260ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 74 | 5 | 5 | 100.0% | 303ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 342 | 103 | 103 | 100.0% | 78ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1627 | 913 | 245 | 26.8% | 257ms | ✅ 正常 |
