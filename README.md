...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 153 | 上游订阅解析后节点数 |
| 可用节点 | 68 | 测速后存活节点数 (剔除前) |
| 最终输出 | 68 | 体积截断后实际输出节点数 |
| 可用率 | 44.4% | 可用节点 / 解析总数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 168 | 4 | 4 | 100.0% | 223ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 56 | 14 | 14 | 100.0% | 377ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 10 | 6 | 6 | 100.0% | 79ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 55 | 3 | 3 | 100.0% | 194ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 220 | 10 | 10 | 100.0% | 230ms | ✅ 正常 |
