...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 63 | 上游订阅解析后节点数 |
| 可用节点 | 63 | 测速后存活节点数 (剔除前) |
| 最终输出 | 63 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 200 | 22 | 9 | 40.9% | 202ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 59 | 23 | 16 | 69.6% | 278ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 10 | 5 | 5 | 100.0% | 139ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 37 | 7 | 7 | 100.0% | 467ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 239 | 6 | 6 | 100.0% | 248ms | ✅ 正常 |
