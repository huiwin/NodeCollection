...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 327 | 上游订阅解析后节点数 |
| 可用节点 | 284 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 86.9% | 可用节点 / 解析总数 |
| 平均延迟 | 186ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 21 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 82 | 4 | 4 | 100.0% | 104ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 30 | 7 | 7 | 100.0% | 526ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 13 | 13 | 100.0% | 25ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 87 | 4 | 4 | 100.0% | 68ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 227 | 7 | 7 | 100.0% | 259ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 520 | 108 | 101 | 93.5% | 62ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 139 | 50 | 50 | 100.0% | 113ms | ✅ 正常 |
