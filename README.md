...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 61 | 上游订阅解析后节点数 |
| 可用节点 | 61 | 测速后存活节点数 (剔除前) |
| 最终输出 | 61 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 194ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 191 | 17 | 5 | 29.4% | 191ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 49 | 24 | 22 | 91.7% | 252ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 12 | 12 | 100.0% | 88ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 75 | 7 | 6 | 85.7% | 203ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 88 | 1 | 1 | 100.0% | 145ms | ✅ 正常 |
