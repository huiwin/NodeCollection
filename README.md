...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1127 | 上游订阅解析后节点数 |
| 可用节点 | 1054 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 93.5% | 可用节点 / 解析总数 |
| 平均延迟 | 239ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 32 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 94 | 4 | 4 | 100.0% | 934ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 50 | 21 | 8 | 38.1% | 391ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 16 | 16 | 100.0% | 17ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 11 | 1 | 1 | 100.0% | 243ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 214 | 8 | 8 | 100.0% | 246ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 342 | 103 | 103 | 100.0% | 64ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1595 | 885 | 259 | 29.3% | 310ms | ✅ 正常 |
