...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 321 | 上游订阅解析后节点数 |
| 可用节点 | 269 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 83.8% | 可用节点 / 解析总数 |
| 平均延迟 | 245ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 34 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 95 | 6 | 6 | 100.0% | 90ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 30 | 7 | 7 | 100.0% | 438ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 14 | 14 | 100.0% | 14ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 77 | 5 | 5 | 100.0% | 120ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 75 | 5 | 5 | 100.0% | 219ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 520 | 103 | 103 | 100.0% | 120ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 138 | 41 | 41 | 100.0% | 171ms | ✅ 正常 |
