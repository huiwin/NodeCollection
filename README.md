...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 67 | 上游订阅解析后节点数 |
| 可用节点 | 67 | 测速后存活节点数 (剔除前) |
| 最终输出 | 67 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 198 | 22 | 10 | 45.5% | 235ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 43 | 17 | 11 | 64.7% | 121ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 11 | 11 | 100.0% | 9ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 100 | 14 | 14 | 100.0% | 241ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 208 | 3 | 3 | 100.0% | 206ms | ✅ 正常 |
