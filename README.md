...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 73 | 上游订阅解析后节点数 |
| 可用节点 | 73 | 测速后存活节点数 (剔除前) |
| 最终输出 | 73 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 193 | 18 | 6 | 33.3% | 192ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 49 | 23 | 21 | 91.3% | 227ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 13 | 13 | 100.0% | 2ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 105 | 18 | 18 | 100.0% | 185ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 89 | 1 | 1 | 100.0% | 157ms | ✅ 正常 |
