...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 383 | 上游订阅解析后节点数 |
| 可用节点 | 323 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 84.3% | 可用节点 / 解析总数 |
| 平均延迟 | 251ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 19 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 75 | 4 | 4 | 100.0% | 146ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 18 | 6 | 6 | 100.0% | 247ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 18 | 18 | 100.0% | 16ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 12 | 0 | 0 | 0.0% | - | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 23 | 8 | 8 | 100.0% | 245ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 438 | 123 | 110 | 89.4% | 76ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 183 | 52 | 52 | 100.0% | 393ms | ✅ 正常 |
