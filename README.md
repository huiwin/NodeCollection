...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1221 | 上游订阅解析后节点数 |
| 可用节点 | 1215 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 99.5% | 可用节点 / 解析总数 |
| 平均延迟 | 201ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 6 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 88 | 18 | 5 | 27.8% | 152ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 31 | 10 | 6 | 60.0% | 865ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 13 | 7 | 7 | 100.0% | 50ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 26 | 4 | 4 | 100.0% | 97ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 216 | 8 | 8 | 100.0% | 274ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 569 | 181 | 168 | 92.8% | 133ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1617 | 903 | 246 | 27.2% | 242ms | ✅ 正常 |
