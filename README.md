...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 166 | 上游订阅解析后节点数 |
| 可用节点 | 166 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 252ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 183 | 16 | 6 | 37.5% | 129ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 63 | 44 | 38 | 86.4% | 370ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 9 | 9 | 100.0% | 2ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 30 | 5 | 5 | 100.0% | 163ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 246 | 10 | 9 | 90.0% | 211ms | ✅ 正常 |
| getNode | [a2470982985/getNode](https://github.com/a2470982985/getNode) | - | - | - | - | - | ⚠️ 异常 (1 次失败) |
| abshare | [abshare/abshare.github.io](https://github.com/abshare/abshare.github.io) | - | - | - | - | - | ⚠️ 异常 (1 次失败) |
| mksshare | [mksshare/mksshare.github.io](https://github.com/mksshare/mksshare.github.io) | - | - | - | - | - | ⚠️ 异常 (1 次失败) |
