...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 114 | 上游订阅解析后节点数 |
| 可用节点 | 114 | 测速后存活节点数 (剔除前) |
| 最终输出 | 114 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 158ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 179 | 15 | 3 | 20.0% | 197ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 45 | 24 | 22 | 91.7% | 266ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 18 | 4 | 4 | 100.0% | 3ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 40 | 3 | 3 | 100.0% | 97ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 180 | 11 | 10 | 90.9% | 200ms | ✅ 正常 |
