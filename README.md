...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1134 | 上游订阅解析后节点数 |
| 可用节点 | 1086 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 95.8% | 可用节点 / 解析总数 |
| 平均延迟 | 181ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 11 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 112 | 21 | 10 | 47.6% | 116ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 44 | 13 | 8 | 61.5% | 508ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 12 | 12 | 100.0% | 18ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 142 | 15 | 15 | 100.0% | 218ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 227 | 7 | 7 | 100.0% | 288ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 398 | 85 | 85 | 100.0% | 17ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1641 | 918 | 240 | 26.1% | 229ms | ✅ 正常 |
