...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1106 | 上游订阅解析后节点数 |
| 可用节点 | 1038 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 93.9% | 可用节点 / 解析总数 |
| 平均延迟 | 183ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 22 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 123 | 7 | 4 | 57.1% | 94ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 36 | 16 | 14 | 87.5% | 253ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 16 | 16 | 100.0% | 24ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 12 | 3 | 3 | 100.0% | 127ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 227 | 8 | 8 | 100.0% | 186ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 308 | 91 | 91 | 100.0% | 24ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1571 | 862 | 244 | 28.3% | 232ms | ✅ 正常 |
