...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 165 | 上游订阅解析后节点数 |
| 可用节点 | 77 | 测速后存活节点数 (剔除前) |
| 最终输出 | 77 | 体积截断后实际输出节点数 |
| 可用率 | 46.7% | 可用节点 / 解析总数 |
| 平均延迟 | 185ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 24 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 163 | 10 | 10 | 100.0% | 107ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 56 | 13 | 13 | 100.0% | 533ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 18 | 5 | 5 | 100.0% | 7ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 80 | 5 | 5 | 100.0% | 56ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 229 | 10 | 10 | 100.0% | 192ms | ✅ 正常 |
