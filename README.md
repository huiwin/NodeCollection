...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1205 | 上游订阅解析后节点数 |
| 可用节点 | 1200 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 99.6% | 可用节点 / 解析总数 |
| 平均延迟 | 192ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 4 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 100 | 21 | 10 | 47.6% | 105ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 31 | 8 | 6 | 75.0% | 589ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 16 | 16 | 100.0% | 20ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 59 | 18 | 16 | 88.9% | 106ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 222 | 7 | 7 | 100.0% | 255ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 569 | 167 | 153 | 91.6% | 95ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1626 | 907 | 249 | 27.5% | 258ms | ✅ 正常 |
