...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 147 | 上游订阅解析后节点数 |
| 可用节点 | 76 | 测速后存活节点数 (剔除前) |
| 最终输出 | 76 | 体积截断后实际输出节点数 |
| 可用率 | 51.7% | 可用节点 / 解析总数 |
| 平均延迟 | 160ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 28 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 138 | 4 | 4 | 100.0% | 155ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 44 | 15 | 15 | 100.0% | 265ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 10 | 10 | 100.0% | 43ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 14 | 2 | 2 | 100.0% | 116ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 273 | 10 | 10 | 100.0% | 226ms | ✅ 正常 |
