...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 140 | 上游订阅解析后节点数 |
| 可用节点 | 140 | 测速后存活节点数 (剔除前) |
| 最终输出 | 140 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 133ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 176 | 16 | 4 | 25.0% | 178ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 63 | 27 | 23 | 85.2% | 257ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 14 | 14 | 100.0% | 46ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 52 | 7 | 7 | 100.0% | 119ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 253 | 15 | 14 | 93.3% | 146ms | ✅ 正常 |
