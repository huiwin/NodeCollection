...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 145 | 上游订阅解析后节点数 |
| 可用节点 | 145 | 测速后存活节点数 (剔除前) |
| 最终输出 | 145 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 196 | 17 | 5 | 29.4% | 302ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 63 | 28 | 22 | 78.6% | 229ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 13 | 13 | 100.0% | 8ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 62 | 16 | 14 | 87.5% | 147ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 253 | 15 | 14 | 93.3% | 127ms | ✅ 正常 |
