...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 159 | 上游订阅解析后节点数 |
| 可用节点 | 159 | 测速后存活节点数 (剔除前) |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 173 | 17 | 6 | 35.3% | 165ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 23 | 11 | 10 | 90.9% | 401ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 14 | 14 | 100.0% | 20ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 50 | 10 | 7 | 70.0% | 313ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 138 | 10 | 8 | 80.0% | 162ms | ✅ 正常 |
