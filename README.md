...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 162 | 上游订阅解析后节点数 |
| 可用节点 | 79 | 测速后存活节点数 (剔除前) |
| 最终输出 | 79 | 体积截断后实际输出节点数 |
| 可用率 | 48.8% | 可用节点 / 解析总数 |
| 平均延迟 | 274ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 24 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 167 | 5 | 5 | 100.0% | 107ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 56 | 13 | 13 | 100.0% | 419ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 4 | 4 | 100.0% | 592ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 67 | 12 | 12 | 100.0% | 140ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 223 | 8 | 8 | 100.0% | 238ms | ✅ 正常 |
