...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1184 | 上游订阅解析后节点数 |
| 可用节点 | 1141 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 96.4% | 可用节点 / 解析总数 |
| 平均延迟 | 271ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 16 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 110 | 17 | 5 | 29.4% | 181ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 52 | 15 | 10 | 66.7% | 830ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 16 | 16 | 100.0% | 36ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 45 | 20 | 20 | 100.0% | 849ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 192 | 7 | 7 | 100.0% | 914ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 398 | 91 | 91 | 100.0% | 25ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1644 | 921 | 265 | 28.8% | 275ms | ✅ 正常 |
