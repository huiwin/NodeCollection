...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1133 | 上游订阅解析后节点数 |
| 可用节点 | 1113 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 98.2% | 可用节点 / 解析总数 |
| 平均延迟 | 165ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 11 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 119 | 21 | 10 | 47.6% | 278ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 36 | 17 | 14 | 82.4% | 240ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 13 | 13 | 100.0% | 33ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 30 | 5 | 5 | 100.0% | 34ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 219 | 8 | 8 | 100.0% | 237ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 342 | 103 | 103 | 100.0% | 65ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1596 | 877 | 274 | 31.2% | 202ms | ✅ 正常 |
