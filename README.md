...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 354 | 上游订阅解析后节点数 |
| 可用节点 | 309 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 87.3% | 可用节点 / 解析总数 |
| 平均延迟 | 302ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 11 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 101 | 15 | 15 | 100.0% | 598ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 18 | 9 | 9 | 100.0% | 587ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 16 | 16 | 100.0% | 113ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 22 | 3 | 3 | 100.0% | 78ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 93 | 8 | 8 | 100.0% | 269ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 345 | 82 | 81 | 98.8% | 39ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 230 | 71 | 71 | 100.0% | 337ms | ✅ 正常 |
