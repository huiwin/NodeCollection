...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1102 | 上游订阅解析后节点数 |
| 可用节点 | 1067 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 96.8% | 可用节点 / 解析总数 |
| 平均延迟 | 149ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 12 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 122 | 7 | 7 | 100.0% | 151ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 36 | 17 | 14 | 82.4% | 221ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 12 | 5 | 5 | 100.0% | 260ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 48 | 5 | 5 | 100.0% | 125ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 228 | 8 | 8 | 100.0% | 210ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 308 | 88 | 88 | 100.0% | 35ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1586 | 879 | 269 | 30.6% | 182ms | ✅ 正常 |
