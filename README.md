...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 137 | 上游订阅解析后节点数 |
| 可用节点 | 137 | 测速后存活节点数 (剔除前) |
| 最终输出 | 137 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 138ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 162 | 20 | 8 | 40.0% | 148ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 40 | 17 | 16 | 94.1% | 402ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 13 | 13 | 100.0% | 3ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 86 | 25 | 23 | 92.0% | 54ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 236 | 13 | 11 | 84.6% | 201ms | ✅ 正常 |
