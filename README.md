...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 108 | 上游订阅解析后节点数 |
| 可用节点 | 108 | 测速后存活节点数 (剔除前) |
| 最终输出 | 108 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 324ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 152 | 17 | 4 | 23.5% | 270ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 40 | 16 | 16 | 100.0% | 712ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 13 | 2 | 2 | 100.0% | 12ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 27 | 7 | 6 | 85.7% | 139ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 259 | 13 | 11 | 84.6% | 238ms | ✅ 正常 |
