...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1142 | 上游订阅解析后节点数 |
| 可用节点 | 1077 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 94.3% | 可用节点 / 解析总数 |
| 平均延迟 | 234ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 22 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 80 | 5 | 4 | 80.0% | 164ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 44 | 14 | 8 | 57.1% | 486ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 14 | 14 | 100.0% | 14ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 20 | 6 | 6 | 100.0% | 255ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 226 | 7 | 7 | 100.0% | 324ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 342 | 103 | 103 | 100.0% | 64ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1628 | 918 | 278 | 30.3% | 299ms | ✅ 正常 |
