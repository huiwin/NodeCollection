...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 1092 | 上游订阅解析后节点数 |
| 可用节点 | 1042 | 测速后存活节点数 (剔除前) |
| 最终输出 | 150 | 体积截断后实际输出节点数 |
| 可用率 | 95.4% | 可用节点 / 解析总数 |
| 平均延迟 | 159ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 17 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 106 | 15 | 4 | 26.7% | 149ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 36 | 17 | 15 | 88.2% | 236ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 14 | 14 | 100.0% | 47ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 18 | 2 | 2 | 100.0% | 142ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 223 | 8 | 8 | 100.0% | 186ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 308 | 91 | 91 | 100.0% | 18ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 1571 | 864 | 239 | 27.7% | 218ms | ✅ 正常 |
