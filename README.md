...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 122 | 上游订阅解析后节点数 |
| 可用节点 | 122 | 测速后存活节点数 (剔除前) |
| 最终输出 | 122 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 182ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 159 | 15 | 3 | 20.0% | 213ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 45 | 24 | 23 | 95.8% | 305ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 10 | 10 | 100.0% | 21ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 48 | 11 | 11 | 100.0% | 94ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 256 | 11 | 10 | 90.9% | 370ms | ✅ 正常 |
