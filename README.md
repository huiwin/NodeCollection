...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 192 | 上游订阅解析后节点数 |
| 可用节点 | 119 | 测速后存活节点数 (剔除前) |
| 最终输出 | 119 | 体积截断后实际输出节点数 |
| 可用率 | 62.0% | 可用节点 / 解析总数 |
| 平均延迟 | 223ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 10 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 172 | 7 | 7 | 100.0% | 96ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 42 | 21 | 21 | 100.0% | 329ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 9 | 9 | 100.0% | 39ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 86 | 33 | 33 | 100.0% | 337ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 304 | 9 | 9 | 100.0% | 208ms | ✅ 正常 |
