...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 387 | 上游订阅解析后节点数 |
| 可用节点 | 345 | 测速后存活节点数 (剔除前) |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 96 | 10 | 10 | 100.0% | 425ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 18 | 6 | 6 | 100.0% | 916ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 16 | 16 | 100.0% | 19ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 51 | 5 | 1 | 20.0% | 162ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 168 | 8 | 8 | 100.0% | 286ms | ✅ 正常 |
| free18 | [free18/v2ray](https://github.com/free18/v2ray) | 438 | 127 | 110 | 86.6% | 44ms | ✅ 正常 |
| free-nodes | [free-nodes/v2rayfree](https://github.com/free-nodes/v2rayfree) | 183 | 63 | 63 | 100.0% | 236ms | ✅ 正常 |
