...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 156 | 上游订阅解析后节点数 |
| 可用节点 | 69 | 测速后存活节点数 (剔除前) |
| 最终输出 | 69 | 体积截断后实际输出节点数 |
| 可用率 | 44.2% | 可用节点 / 解析总数 |
| 平均延迟 | 213ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 28 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 171 | 7 | 7 | 100.0% | 179ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 44 | 9 | 9 | 100.0% | 572ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 5 | 5 | 100.0% | 15ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 36 | 1 | 1 | 100.0% | 111ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 298 | 10 | 10 | 100.0% | 245ms | ✅ 正常 |
