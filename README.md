...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 81 | 上游订阅解析后节点数 |
| 可用节点 | 81 | 测速后存活节点数 (剔除前) |
| 最终输出 | 81 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 188 | 23 | 8 | 34.8% | 168ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 43 | 24 | 18 | 75.0% | 263ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 13 | 13 | 100.0% | 16ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 64 | 18 | 17 | 94.4% | 130ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 158 | 3 | 3 | 100.0% | 300ms | ✅ 正常 |
