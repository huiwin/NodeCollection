...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 123 | 上游订阅解析后节点数 |
| 可用节点 | 123 | 测速后存活节点数 (剔除前) |
| 最终输出 | 123 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 142ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 171 | 15 | 3 | 20.0% | 191ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 45 | 24 | 23 | 95.8% | 290ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 14 | 14 | 100.0% | 8ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 34 | 7 | 5 | 71.4% | 206ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 180 | 11 | 10 | 90.9% | 127ms | ✅ 正常 |
