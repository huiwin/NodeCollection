...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 157 | 上游订阅解析后节点数 |
| 可用节点 | 89 | 测速后存活节点数 (剔除前) |
| 最终输出 | 89 | 体积截断后实际输出节点数 |
| 可用率 | 56.7% | 可用节点 / 解析总数 |
| 平均延迟 | 255ms | 可达节点的平均 TCP 握手延迟 |
| 已剔除 | 4 | 连续不可达被剔除的节点数 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 162 | 4 | 4 | 100.0% | 188ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 42 | 20 | 20 | 100.0% | 416ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 18 | 9 | 9 | 100.0% | 276ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 50 | 8 | 8 | 100.0% | 165ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 280 | 9 | 9 | 100.0% | 228ms | ✅ 正常 |
