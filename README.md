...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 135 | 上游订阅解析后节点数 |
| 可用节点 | 135 | 测速后存活节点数 (剔除前) |
| 最终输出 | 135 | 体积截断后实际输出节点数 |
| 可用率 | 100.0% | 可用节点 / 解析总数 |
| 平均延迟 | 397ms | 可达节点的平均 TCP 握手延迟 |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 172 | 18 | 6 | 33.3% | 220ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 63 | 42 | 37 | 88.1% | 542ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 4 | 4 | 100.0% | 6ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 29 | 3 | 2 | 66.7% | 188ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 197 | 10 | 9 | 90.0% | 234ms | ✅ 正常 |
