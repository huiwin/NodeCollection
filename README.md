...
| 指标 | 数值 | 说明 |
| :--- | ---: | :--- |
| 解析节点总数 | 167 | 上游订阅解析后节点数 |
| 可用节点 | 167 | 测速后存活节点数 (剔除前) |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | :--- |
| NoMoreWalls | [peasoft/NoMoreWalls](https://github.com/peasoft/NoMoreWalls) | 179 | 23 | 12 | 52.2% | 307ms | ✅ 正常 |
| FreeNodes | [Barabama/FreeNodes](https://github.com/Barabama/FreeNodes) | 47 | 16 | 13 | 81.2% | 358ms | ✅ 正常 |
| Pawdroid | [Pawdroid/Free-servers](https://github.com/Pawdroid/Free-servers) | 20 | 8 | 8 | 100.0% | 2ms | ✅ 正常 |
| Jsnzkpg | [Jsnzkpg/Jsnzkpg](https://github.com/Jsnzkpg/Jsnzkpg) | 53 | 10 | 7 | 70.0% | 299ms | ✅ 正常 |
| maflya | [maflya](https://sub.maflya.com/) | 140 | 11 | 9 | 81.8% | 367ms | ✅ 正常 |
